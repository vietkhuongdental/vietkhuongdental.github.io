...
export function HealthRecordIcon({ isFilled }: Props) {
  return isFilled ? <FilledHealthRecord /> : <UnfilledHealthRecord />;
}

function FilledHealthRecord() {
  return (
    <svg
      fill="none"
      height="22"
